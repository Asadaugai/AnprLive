...
def main():
    st.title("PetroI - Video Processor")
    ...
    today_plates_container = st.empty()
    ...
    with st.sidebar:
        ...
        total_plates_container = st.empty()
    ...
    if uploaded_file is not None:
        ...
        try:
            while cap.isOpened():
                ...
                # Update main screen
                stream_placeholder.image(frame_combined_rgb, caption="Vehicle and License Plate Detection", use_container_width=True)

                # Update sidebar: Live plates
